...
void multiplicacionMatrices(float A[FIL][COL], int FILa, int COLa, float B[FIL][COL], int FILb, int COLb, float P[FIL][COL]);
...
int main()
{
    ...
    cout << "Para que se puedan multiplicar, la segunda matriz debe tener el mismo orden: " << n << " x " << n << "\n";
    filB = n;
    colB = n;
